...
import com.miki.bedrockite.procedures.BedrockStartCrackingProcedure;
import com.miki.bedrockite.procedures.BedrockCrackedProcedure;
...
public class BedrockitePickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(BedrockiteModItems.BEDROCKITE_INGOT.get()));
		}
	};
